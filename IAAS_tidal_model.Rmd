...
fpC_nitrogen <- transform(fpC_nitrogen, N_mass = ifelse(species == "No_fp" | species == "Ni_fp" | species == "Na_fp", V_fp*concentration, 
                                                 ifelse(species == "No_sd" | species == "Ni_sd" | species == "Na_sd", V_sed*concentration,
                                                        ifelse(species == "alg", concentration/alg_CN*V_fp/h_fp, concentration*FCR/alg_CN*V_fp/h_fp)))) # converting fish C to alg C via FCR and then alg C to N using Redfield ratio
...
fpU_nitrogen <- transform(fpU_nitrogen, N_mass = ifelse(species == "No_fp" | species == "Ni_fp" | species == "Na_fp", V_fp*concentration, 
                                                 ifelse(species == "No_sd" | species == "Ni_sd" | species == "Na_sd", V_sed*concentration,
                                                        ifelse(species == "alg", concentration/alg_CN*V_fp/h_fp, concentration*FCR/alg_CN*V_fp/h_fp)))) # theoretically converting fish C to alg C via FCR and then alg C to N using Redfield ratio
